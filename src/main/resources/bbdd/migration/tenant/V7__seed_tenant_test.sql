...
-- --------------------------------------------------------
INSERT INTO workers
(tenant_id, first_name, second_name, first_surname, second_surname, dni_nie, email, password, main_phone, second_phone, is_active, created_at, updated_at, created_by, updated_by)
VALUES
    -- nombre.1234
    ('${tenantId}', 'Ana', 'María', 'García', 'López', 'Z2033087A', 'ana.garcia@email.com', '$2a$10$YSG0CxvdgvJSJpcfwu.fMu0N2dl0T.ZY7AsjWyFoeJGsTwuIwNld2', '600123456', '911223344', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Carlos', NULL, 'Rodríguez', 'Sánchez', 'Z2333087A', 'carlos.rod@email.com', '$2a$10$HoyuWvxttsqA8xx48J2nFeMmOdJG8wAqCZiyb8HwBLAjEkqgEy2bW', '655987654', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Lucía', 'Carmen', 'Fernández', NULL, 'Z2033037C', 'lucia.fer@email.com', '$2a$10$7Ak69vQ2SeihHwYuRGIMJ.4R5HYe19kw8Xm32LsRg.irEZkYqVrVK', '611222333', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Miguel', NULL, 'Torres', 'Ruiz', 'Z2033083J', 'miguel.torres@email.com', '$2a$10$oGs.v.J17eussnjKMECI/e/SbAt4hHE66Syw2W22p/za5Vz9jJPjm', '699888777', '933445566', false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Elena', NULL, 'Moreno', 'Díaz', 'Z2343087A', 'elena.moreno@email.com', '$2a$10$JnnN0CCHqpj7W.Z4ZQ4f5eSGNWo7vXtmPIs46uVIC54VhiGzuRPl.', '622333444', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Roberto', NULL, 'Sanz', 'Gil', 'Z2033547T', 'roberto.rrhh@email.com', '$2a$10$bG9.VzvrJdQYLjwAy.FUqux9XI7/9GQ/fGm9DLHVhNyoS2mrC01ti', '600666666', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Beatriz', NULL, 'Molina', 'Pérez', 'Z2036687F', 'bea.recep@email.com', '$2a$10$nvjdcOUwNm0epxmTqVrH1e3iCglpj./GWvkWvlYh9i1KHu471SH9.', '600777777', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Laura', NULL, 'Ruiz', 'Giménez', 'Z2273087A', 'laura.fisio@email.com', '$2a$10$mmBN5zfm5kazBzI3AZFRJeKpAV4beO.coVp4CNsfsQdPRBoR6FMFq', '600888888', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Pablo', 'José', 'Martín', 'Sanz', 'Z2038487B', 'pablo.to@email.com', '$2a$10$S2RpsQqehOpnAWocciGo4uBOB1nOSf.94fNWF.c0fv24wXuoFRr7u', '600999999', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Sara', NULL, 'Díaz', 'Romero', 'Z2033447A', 'sara.ts@email.com', '$2a$10$icE/.qMFLze5QQHGr7hWM.vXiClJvjSOZiohRF98QG/qpTHBneVP6', '611000111', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'David', NULL, 'Serrano', 'Molina', 'Z2333087Y', 'david.psico@email.com', '$2a$10$o07O4gxOqQfrearllI8CtuJa2p1F8dkaHRyaoGeui44vwCuJcydDW', '611222333', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Carmen', 'Luisa', 'Ortiz', 'Vega', 'Z2233087A', 'carmen.gero@email.com', '$2a$10$TzeYlyew2gK2WG7qxCi4SO4KdCzP5b.c.Sv8XaMP6cs8lY0vklHPG', '611333444', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Javier', NULL, 'Navarro', 'Flores', 'Z2133087Y', 'javier.tas@email.com', '$2a$10$F3a/pNydNFruvtoLN5Sg3.0L4d0i/JMQudboVUrEir06qbjYHxZuy', '611444555', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Manuel', 'Antonio', 'Iglesias', 'Vargas', 'Z2035587A', 'manolo.ruta@email.com', '$2a$10$4iIMSPJ6BoEF1XsoAbs6me8pC6WCewNln5mZbMK/vMVmcWGHBZuhm', '611555666', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Julián', NULL, 'Vázquez', 'Rey', 'Z2036697A', 'julian.copi@email.com', '$2a$10$yDETH5eolJkrLrrXv9XAqeyZ6PTdt1IuFErQ1Y3wFx4xfWv/qBP0e', '611666777', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system'),
    ('${tenantId}', 'Rosa', 'María', 'Vidal', 'Sáez', 'Z2037787A', 'rosa.limpieza@email.com', '$2a$10$VQSEF2rYQhhc0Wu9gDEnCu0348x3AUc5aGGH0YuebPitew//w6Ule', '611777888', NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system');
