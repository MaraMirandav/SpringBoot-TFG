...
import com.centros_sass.app.mapper.profiles.WorkerScheduleRecordMapper;
...
public class WorkerScheduleRecordServiceImpl implements WorkerScheduleRecordService {
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<WorkerScheduleRecordResponseDTO> findAllInactive(Pageable pageable) {
        return recordRepository.findAllByIsActiveFalse(pageable)
                .map(recordMapper::toResponse);
    }
