...
@NoArgsConstructor
@AllArgsConstructor
public class MedicationApplication extends BaseEntity implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        MedicationApplication other = (MedicationApplication) obj;
        if (id == null) {
            if (other.id != null)
                return false;
    ...
    public String toString() {
        return "MedicationApplication [id=" + id + ", applicationName=" + medicationApplicationName + "]";
    }
}
